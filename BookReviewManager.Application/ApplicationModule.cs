...
namespace BookReviewManager.Application
{
    public static class ApplicationModule
    {
      ...
      config.RegisterServicesFromAssemblyContaining<CreateBookCommand>());
            ...
            services.AddTransient<IPipelineBehavior<CreateBookCommand, ResultVM<int>>,
                ValidateCreateBookCommandBehavior>();

            services.AddTransient<IPipelineBehavior<UpdateBookCoverCommand, ResultVM>,
                ValidateUpdateBookCoverCommandBehavior>();

            services.AddTransient<IPipelineBehavior<CreateUserCommand, ResultVM<int>>,
                ValidateCreateUserCommandBehavior>();

            services.AddTransient<IPipelineBehavior<AddReviewCommand, ResultVM<int>>,
                ValidateAddReviewCommandBehavior>();

            services.AddTransient<IPipelineBehavior<UpdateUserCommand, ResultVM>,
                ValidateUpdateUserCommandBehavior>();

            services.AddTransient<IPipelineBehavior<DeleteUserCommand, ResultVM>,
                ValidateDeleteUserCommandBehavior>();

            services.AddTransient<
    IPipelineBehavior<LoginUserCommand, ResultVM<LoginUserResponseDto>>,
    ValidateLoginUserCommandBehavior>();
